...
int forkItTwice() {
	...
	msgs[0] = gen_str("fc2c-"); // From Child To Child
	msgs[1] = gen_str("fc2p-"); // From Child To Parent
	msgs[2] = gen_str("fc2g-"); // From Child To Grandparent
	msgs[3] = gen_str("fp2c-"); // ...
	msgs[4] = gen_str("fp2p-");
	msgs[5] = gen_str("fp2g-");
	msgs[6] = gen_str("fg2c-");
	msgs[7] = gen_str("fg2p-");
	msgs[8] = gen_str("fg2g-"); // From Grandparent To Grandparent
...
int forkItOnce() {
	...
	char fathe4[] = "You're welcome, Child";
...
int joinLeaveTest() {
	...
	success = (queue_ids[0] = lfattach("zero\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[1] = lfattach("un\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[2] = lfattach("deux\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[3] = lfattach("trois\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[4] = lfattach("quatre\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[5] = lfattach("cinq\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[6] = lfattach("six\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[7] = lfattach("sept\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[8] = lfattach("huit\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[9] = lfattach("neuf\0")) >= 0;
	printf("[%d] Queue Attach", success);
	
	success = lfleave(queue_id[1]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[3]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[5]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[7]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[9]);
	printf("[%d] Queue Leave", success);
	
	success = (queue_ids[1] = lfattach("dix\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[3] = lfattach("onze\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[5] = lfattach("douze\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[7] = lfattach("treize\0")) >= 0;
	printf("[%d] Queue Attach", success);
	success = (queue_ids[9] = lfattach("quatorze\0")) >= 0;
	printf("[%d] Queue Attach", success);
	
	success = lfsend(queue_id[0], "0", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[1], "1", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[2], "2", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[3], "3", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[4], "4", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[5], "5", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[6], "6", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[7], "7", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[8], "8", 1);
	printf("[%d] Message Send", success);
	success = lfsend(queue_id[9], "9", 1);
	printf("[%d] Message Send", success);
	
	success = lfleave(queue_id[0]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[1]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[2]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[3]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[4]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[5]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[6]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[7]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[8]);
	printf("[%d] Queue Leave", success);
	success = lfleave(queue_id[9]);
	printf("[%d] Queue Leave", success);
